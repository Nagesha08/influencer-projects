...
export async function verifyFirebaseToken(token) {
    ...
    if (!firebaseAuth) {
        throw new Error("Firebase Admin is not configured. Set one of these in backend/.env: FIREBASE_SERVICE_ACCOUNT_JSON, FIREBASE_SERVICE_ACCOUNT_PATH, or FIREBASE_PROJECT_ID + FIREBASE_CLIENT_EMAIL + FIREBASE_PRIVATE_KEY.");
    }
